...
if __name__ == '__main__':
    ...
    model_meshes, o3d_mesh = get_model_meshes(model_paths[2:3])
    real_points, o3d_real_points, scene_pcd = get_real_points(segments_paths[2:3], init_trans)
    ...
    for target_idx, pair_list in tqdm(optimization_pairs.items(), total=len(optimization_pairs), leave=False):
        ...
        if (best_result[1] < min(historical_best_V * 1.5, 0.01)):
